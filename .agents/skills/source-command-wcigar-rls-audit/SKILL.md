---
name: "source-command-wcigar-rls-audit"
description: "全面稽核 96 張表的 RLS — 找裸奔表、太鬆 policy、商業機密外洩風險"
---

# source-command-wcigar-rls-audit

Use this skill when the user asks to run the migrated source command `wcigar-rls-audit`.
