---
name: "source-command-wcigar-deploy-check"
description: "部署前的最後檢查 — 列出所有要做的事、順序、smoke test，避免凌晨救火"
---

# source-command-wcigar-deploy-check

Use this skill when the user asks to run the migrated source command `wcigar-deploy-check`.
