---
name: "source-command-wcigar-revenue-pulse"
description: "早上 30 秒給老闆的營運脈動 — 4 channel 對比、異常警報、庫存、大使、VIP 提醒"
---

# source-command-wcigar-revenue-pulse

Use this skill when the user asks to run the migrated source command `wcigar-revenue-pulse`.
