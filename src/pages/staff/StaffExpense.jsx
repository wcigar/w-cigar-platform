      ...
      {showCashForm && (
        <div className="card" style={{ padding: 16, marginBottom: 14, borderColor: 'rgba(77,168,108,.3)' }}>
          ...
          <div style={{ position: 'relative', marginBottom: 10 }}>
            ...
            <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="金額" value={cashForm.amount} onChange={e => setCashForm(p => ({ ...p, amount: e.target.value }))} style={{ width: '100%', paddingLeft: 34, fontSize: 24, fontFamily: 'var(--font-mono)', fontWeight: 700, padding: '12px 12px 12px 34px' }} />
          </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
            <div style={{ flex: 1, position: 'relative' }}>
              ...
              <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="金額" value={form.amount} onChange={e => setForm(p => ({ ...p, amount: e.target.value }))} style={{ width: '100%', paddingLeft: 32, fontSize: 22, fontFamily: 'var(--font-mono)', fontWeight: 700, padding: '12px 12px 12px 32px' }} />
            </div>
