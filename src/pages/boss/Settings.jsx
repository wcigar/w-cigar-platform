              ...
              {editing?.task_id === d.task_id ? (
                <div>
                  ...
                  <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    <input type="tel" inputMode="numeric" pattern="[0-9]*" value={editing.weight} onChange={e => setEditing(p => ({ ...p, weight: +e.target.value }))} style={{ width: 50, fontSize: 12, padding: 6 }} min={1} max={3} />
      ...
      {adding && (
        <div className="card" style={{ marginTop: 12, padding: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 8, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <input type="tel" inputMode="numeric" pattern="[0-9]*" value={newTask.weight} onChange={e => setNewTask(p => ({ ...p, weight: +e.target.value }))} placeholder="權重" style={{ width: 60, fontSize: 13, padding: 8 }} min={1} max={3} />
