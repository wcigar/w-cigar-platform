...
const DEFAULT_PRODUCTS = [
  ...
  { key: 'siglo2_tube',      name: '2號鋁管',        price: 1800, category: 'cuban_cigar' },
  { key: 'romeo_wide',       name: '羅密歐寬丘',     price: 2000, category: 'cuban_cigar' },
  ...
  { key: 'robusto',          name: 'COHIBA羅布圖',   price: 2500, category: 'cuban_cigar' },
  { key: 'siglo6_tube',      name: 'COHIBA六號鋁管', price: 2800, category: 'cuban_cigar' },
]
...
const TAIPEI_VENUE_TEMPLATE = [
  { id: 'westin',           name: '威士登',      region: 'taipei',
    products: [
      ...
      { key: 'capadura_888_torpedo', name: 'Capadura 888 Torpedo', price: 1000, category: 'non_cuban_cigar' },
      { key: 'capadura_898_torpedo', name: 'Capadura 898 Torpedo', price: 1000, category: 'non_cuban_cigar' },
      { key: 'romeo',             name: '羅密歐',            price: 1500, category: 'cuban_cigar' },
      { key: 'trinidad_emerald', name: '3T翡翠',        price: 2000, category: 'cuban_cigar' },
      { key: 'd4',               name: '帕特加斯D4號',                 price: 2000, category: 'cuban_cigar' },
      { key: 'monte_no2',        name: '蒙特二號',            price: 2000, category: 'cuban_cigar' },
  ...
  { id: 'hongxin',          name: '鴻欣',        region: 'taipei',
    products: [
      ...
      { key: 'romeo_wide',       name: '羅密歐寬丘',          price: 2000, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA羅布圖',            price: 2500, category: 'cuban_cigar' },
      { key: 'siglo6_tube_mentor',name: 'COHIBA六號鋁管/導師',     price: 2800, category: 'cuban_cigar' },
    ],
  },
  ...
  { id: 'flare',            name: 'Flare',       region: 'taipei', note: '特殊價格模板',
    products: [
      ...
      { key: 'd4',                name: '帕特加斯D4號',               price: 2400, category: 'cuban_cigar' },
      { key: 'monte',             name: '蒙特',              price: 2450, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA羅布圖',            price: 3500, category: 'cuban_cigar' },
      { key: 'siglo6_tube',       name: 'COHIBA六號鋁管',          price: 2800, category: 'cuban_cigar' },
    ],
  },
  { id: 'jinsha',           name: '金沙',        region: 'taipei', note: '特殊價格模板',
    products: [
      ...
      { key: 'partagas_d4_2500',  name: '帕特加斯D4號',      price: 2500, category: 'cuban_cigar' },
      { key: 'monte_no2_2500',    name: '蒙特二號',          price: 2500, category: 'cuban_cigar' },
      { key: 'trinidad_3t',       name: '3T翡翠',           price: 3500, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA羅布圖',            price: 3000, category: 'cuban_cigar' },
      { key: 'siglo6_tube',       name: 'COHIBA六號鋁管',          price: 3500, category: 'cuban_cigar' },
    ],
  },
  { id: 'jinnadu',          name: '金拿督',      region: 'taipei', note: '特殊價格模板',
    products: [
      ...
      { key: 'robusto',           name: 'COHIBA羅布圖',            price: 3500, category: 'cuban_cigar' },
      { key: 'd4',                name: '帕特加斯D4號',               price: 3500, category: 'cuban_cigar' },
    ],
  },
]
...
const TAICHUNG_VENUE_TEMPLATE = [
  { id: 'zijue',    name: '紫爵',    region: 'taichung',
    products: [
      ...
      { key: 'capadura_888_torpedo', name: 'Capadura 888 Torpedo', price: 1000, category: 'non_cuban_cigar' },
      { key: 'capadura_898_torpedo', name: 'Capadura 898 Torpedo', price: 1000, category: 'non_cuban_cigar' },
      { key: 'trinidad_emerald_2000', name: '3T翡翠',           price: 2000, category: 'cuban_cigar' },
      { key: 'monte_no2_2000',        name: '蒙特二號',          price: 2000, category: 'cuban_cigar' },
      { key: 'partagas_d4_2000',      name: '帕特加斯D4號',      price: 2000, category: 'cuban_cigar' },
      { key: 'robusto',        name: 'COHIBA羅布圖',          price: 3000, category: 'cuban_cigar' },
      { key: 'robusto_siglo6', name: 'COHIBA羅布圖/六號鋁管', price: 3000, category: 'cuban_cigar' },
    ],
  },
  { id: 'jinlidu',  name: '金麗都',  region: 'taichung',
    products: [
      ...
      { key: 'monte_no2_2000',        name: '蒙特二號',          price: 2000, category: 'cuban_cigar' },
      { key: 'partagas_d4_2000',      name: '帕特加斯D4號',      price: 2000, category: 'cuban_cigar' },
      { key: 'siglo6_robusto', name: 'COHIBA六號鋁管/羅布圖', price: 2500, category: 'cuban_cigar' },
    ],
  },
  { id: 'soak',     name: 'soak',    region: 'taichung',
    products: [
      ...
      { key: 'trinidad_emerald_2200', name: '3T翡翠',           price: 2200, category: 'cuban_cigar' },
      { key: 'monte_no2_2200',        name: '蒙特二號',          price: 2200, category: 'cuban_cigar' },
      { key: 'partagas_d4_2200',      name: '帕特加斯D4號',      price: 2200, category: 'cuban_cigar' },
      { key: 'siglo6_robusto', name: 'COHIBA六號鋁管/羅布圖', price: 3000, category: 'cuban_cigar' },
    ],
  },
  { id: 'shenhua',  name: '神話',    region: 'taichung',
    products: [
      ...
      { key: 'monte_no2_2200',        name: '蒙特二號',          price: 2200, category: 'cuban_cigar' },
      { key: 'partagas_d4_2200',      name: '帕特加斯D4號',      price: 2200, category: 'cuban_cigar' },
      { key: 'siglo6_tube',    name: 'COHIBA六號鋁管',        price: 3000, category: 'cuban_cigar' },
    ],
  },
