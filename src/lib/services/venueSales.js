...
const DEFAULT_PRODUCTS = [
  ...
  { key: 'romeo_wide',       name: '羅密歐寬邱',  price: 1500, category: 'cuban_cigar' },
...
const TAIPEI_VENUE_TEMPLATE = [
  { id: 'westin',           name: '威士登',      region: 'taipei',
    products: [
      ...
      { key: 'd4',               name: '帕特加斯D4號',                 price: 2000, category: 'cuban_cigar' },
      { key: 'monte_no2',        name: '蒙特二號',            price: 2000, category: 'cuban_cigar' },
      { key: 'romeo_wide',       name: '羅密歐寬邱',          price: 2000, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA 羅布圖',            price: 2500, category: 'cuban_cigar' },
      { key: 'siglo6_tube',       name: 'COHIBA 六號鋁管',          price: 2800, category: 'cuban_cigar' },
    ],
  },
  ...
  { id: 'hongxin',          name: '鴻欣',        region: 'taipei',
    products: [
      ...
      { key: 'romeo_wide',       name: '羅密歐寬邱',          price: 2000, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA 羅布圖',            price: 2500, category: 'cuban_cigar' },
      { key: 'siglo6_tube_mentor',name: 'COHIBA 六號鋁管/導師',     price: 2800, category: 'cuban_cigar' },
    ],
  },
  ...
  { id: 'flare',            name: 'Flare',       region: 'taipei', note: '特殊價格模板',
    products: [
      ...
      { key: 'romeo_wide_churchill', name: '羅密歐寬邱',    price: 2700, category: 'cuban_cigar' },
      { key: 'd4',                name: '帕特加斯D4號',               price: 2400, category: 'cuban_cigar' },
      { key: 'monte',             name: '蒙特',              price: 2450, category: 'cuban_cigar' },
      { key: 'robusto',           name: 'COHIBA 羅布圖',            price: 3500, category: 'cuban_cigar' },
      { key: 'siglo6_tube',       name: 'COHIBA 六號鋁管',          price: 2800, category: 'cuban_cigar' },
    ],
  },
  { id: 'jinsha',           name: '金沙',        region: 'taipei', note: '特殊價格模板',
    products: [
      ...
      { key: 'romeo',             name: '羅密歐二號鋁管',            price: 1800, category: 'cuban_cigar' },
      ...
      { key: 'robusto',           name: 'COHIBA 羅布圖',            price: 3000, category: 'cuban_cigar' },
      { key: 'siglo6_tube',       name: 'COHIBA 六號鋁管',          price: 3500, category: 'cuban_cigar' },
    ],
  },
...
const TAICHUNG_VENUE_TEMPLATE = [
  ...
  { id: 'soak',     name: 'soak',    region: 'taichung',
    products: [
      { key: 'capadura',       name: 'capadura',       price: 1100, category: 'non_cuban_cigar' },
      { key: 'romeo',          name: '羅密歐二號鋁管',          price: 1600, category: 'cuban_cigar' },
  ...
  { id: 'shenhua',  name: '神話',    region: 'taichung',
    products: [
      ...
      { key: 'monte_no2_2200',        name: '蒙特二號',          price: 2200, category: 'cuban_cigar' },
      { key: 'partagas_d4_2200',      name: '帕特加斯D4號',      price: 2200, category: 'cuban_cigar' },
      { key: 'siglo6_tube',    name: 'COHIBA 六號鋁管',        price: 3000, category: 'cuban_cigar' },
    ],
  },
