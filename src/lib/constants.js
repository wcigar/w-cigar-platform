...
// 勞保投保薪資分級表（2025-09 起、含部分工時級距）
// 部分工時最低 11100、一般員工最低 29500、最高 45800
export const LABOR_INS_BRACKETS = [
  11100, 12540, 13500, 15840, 16500, 17280, 17880, 19047, 20008, 21009, 22000, 23100, 24000, 25250, 26400, 27600, 28800,  // 部分工時
  29500, 30300, 31800, 33300, 34800, 36300, 38200, 40100, 42000, 43900, 45800  // 一般
]
// 健保投保金額分級表（2025-01 起、最低 29500、無部分工時、上限 219500，此處給常用範圍）
export const HEALTH_INS_BRACKETS = [
  29500, 30300, 31800, 33300, 34800, 36300, 38200, 40100, 42000, 43900, 45800,
  48200, 50600, 53000, 55400, 57800, 60800, 63800, 66800, 69800,
